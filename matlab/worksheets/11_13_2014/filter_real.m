...
fn_out = './worksheets/11_13_2014/data_real.mat';
N = 200000;
binsize = 0.002;
dur = N*binsize;
dt_sp = binsize;
...
for j = 1:length(nK_poss);
	...
	data = filters_sp_vel(pre, nK_sp, nK_pos, dt_sp, dt_pos);
	...
	fn_out2 = ['./worksheets/11_13_2014/plots/filters_dtpos_' num2str(dt_pos)];
...
hold on
xlabel('time (s)')
fn_out3 = ['./worksheets/11_13_2014/plots/filters.eps'];
...
xlabel('time(s)')
fn_out3 = ['./worksheets/11_13_2014/plots/filters_fourier.eps'];
saveplot(gcf, fn_out3, 'eps', [9 6]);
...
xlabel('resolution (s)')
ylabel('Likelihood')
saveplot(gcf, './worksheets/11_13_2014/plots/filters_dev.eps')
