...
saveplot(gcf, './worksheets/2016_05_04-bcireport_successes/tuningstrengthBCI-nonBCI-boxplot.eps')
...
colormap(colors)
subplot(2,2,1)
scatter(all_r2(rot,1), all_r2(rot,2), [], c(rot))
xlabel('strength MC1')
ylabel('strength BC1')
title(['corr bci: ' num2str(corrsbci(1)) ' corr nonbci: ' num2str(corrsnonbci(1))])
subplot(2,2,2)
scatter(all_r2(rot,1), all_r2(rot,3), [], c(rot))
xlabel('strength MC1')
ylabel('strength DC')
title(['corr bci: ' num2str(corrsbci(2)) ' corr nonbci: ' num2str(corrsnonbci(2))])
subplot(2,2,3)
scatter(all_r2(rot,2), all_r2(rot,3), [], c(rot))
xlabel('strength BC1')
ylabel('strength DC')
title(['corr bci: ' num2str(corrsbci(3)) ' corr nonbci: ' num2str(corrsnonbci(3))])
saveplot(gcf, './worksheets/2016_05_04-bcireport_successes/tuningstrengthBCI-nonBCI-scatter.eps')
