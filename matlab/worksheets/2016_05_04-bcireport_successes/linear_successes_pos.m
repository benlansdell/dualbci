...
for idx = 1:nR
	...
	if exist([blackrock nevfile], 'file') & exist([blackrock BCnevfile], 'file') & exist([blackrock DCnevfile], 'file') & exist([blackrock MC2nevfile], 'file')
		...
		processLinearSuccessPosition(conn, modelID, blackrock, BCnevfile, paramcode, threshold, allunits, rerun);
		processLinearSuccessPosition(conn, modelID, blackrock, DCnevfile, paramcode, threshold, allunits, rerun);
		processLinearSuccessPosition(conn, modelID, blackrock, MC2nevfile, paramcode, threshold, allunits, rerun);
	else
