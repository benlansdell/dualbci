...
'ON flin2.id = fl2.id '...
'WHERE flin1.modelID = 30 AND flin2.modelID = 30 AND fgranger.modelID = 2']));
...
xlim([-180 180])
ylim([0 40])
saveplot(gcf, './worksheets/2015_11_25-GrangerVsTuningAngleVel/GCvtuning_alldata.eps')
...
xlabel('Difference in tuning angles between units')
title('Brain+manual. Ipsi+contra')
saveplot(gcf, './worksheets/2015_11_25-GrangerVsTuningAngleVel/tuningvpropsig_alldata.eps')
...
xlim([-180 180])
ylim([0 40])
saveplot(gcf, './worksheets/2015_11_25-GrangerVsTuningAngleVel/GCvtuning_MCdata.eps')
...
xlabel('Difference in tuning angles between units')
title('manual. Ipsi+contra')
saveplot(gcf, './worksheets/2015_11_25-GrangerVsTuningAngleVel/tuningvpropsig_MCdata.eps')
...
xlim([-180 180])
ylim([0 40])
saveplot(gcf, './worksheets/2015_11_25-GrangerVsTuningAngleVel/GCvtuning_BCdata.eps')
...
xlabel('Difference in tuning angles between units')
title('Brain. Ipsi+contra')
saveplot(gcf, './worksheets/2015_11_25-GrangerVsTuningAngleVel/tuningvpropsig_BCdata.eps')
