...
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/GCvtuning_MC_BC_data.eps')
...
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/GCvtuning_MC_hemispheres_data.eps')
...
ylim([0 30])
legend([h1, h3], 'contra-contra', 'contra-ipsi')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/GCvtuning_BC_hemispheres_data.eps')
...
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/tuningvpropsig_MC_BC_data.eps')
...
xlabel('$\theta_j-\theta_i$')
legend([h1, h3], 'contra->contra', 'contra->ipsi')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/tuningvpropsig_MC_hemispheres_data.eps')
...
xlabel('$\theta_j-\theta_i$')
legend([h1, h3], 'contra->contra', 'contra->ipsi')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/tuningvpropsig_BC_hemispheres_data.eps')
...
ylim([0 .4])
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/gcscorevproptuned_MC_BC.eps')
...
ylim([0 .4])
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/gcscorevproptuned_MC_hemispheres.eps')
...
legend('contra->contra', 'contra->ipsi', 'ipsi->contra', 'location', 'northeast')
ylim([0 .4])
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/gcscorevproptuned_BC_hemispheres.eps')
...
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/gcscorevtuningoverlap_BC.eps')
...
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/hist_tuning_all.eps')
hist(MC_d(:,2)/pi*180, 50) 
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/hist_tuning_MC.eps')
hist(BC_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/hist_tuning_BC.eps')
hist(MC_CC_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/hist_tuning_MC_CC.eps')
hist(MC_CI_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/hist_tuning_MC_CI.eps')
hist(MC_IC_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/hist_tuning_MC_IC.eps')
hist(MC_II_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/hist_tuning_MC_II.eps')
hist(BC_IC_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/hist_tuning_BC_IC.eps')
hist(BC_II_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/hist_tuning_BC_II.eps')
hist(BC_CI_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/hist_tuning_BC_CI.eps')
hist(BC_CC_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/hist_tuning_BC_CC.eps')
...
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/MC_tuningsize_angle.eps')

plot(angles, BC_meantuningsizebinned)
xlabel('Angle')
ylabel('Mean tuning strength')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/BC_tuningsize_angle.eps')
...
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/prop_fe_ru_MC.eps')
...
xlim([0 gcthresholds(ii(end))]);
legend('other', 'both tuned RU', 'both tuned FE', 'location', 'northwest')
saveplot(gcf, './worksheets/2015_08_08-GrangerVsTuningAngle/prop_fe_ru_BC.eps')
