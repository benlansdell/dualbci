...
for rep = 1:nR
	...
	for idx = 1:length(files)
		...
		for j = 1:length(cotunedunits)
			...
			'AND (et.`tuning_type` = 1 OR et.`tuning_type` = 3 OR et.`tuning_type` = 4)']));
...
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/Granger-decoupling-MC-BC_histogram_bootstrap_rotated.eps')

figure 
qqplot(dcotuned, dother)
[h, p] = kstest2(dcotuned, dother)
title(['kstest2: p = ' num2str(p)])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/Granger-decoupling-MC-BC_qqplot_bootstrap_rotated.eps')
...
[h, p] = ttest2(abs(dcotuned), abs(dother))
title(['abs(dcotuned)vs abs(dother) p-value: ' num2str(p)])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/Granger-decoupling-MC-DC_histogram_bootstrap_rotated.eps')
...
[h, p] = kstest2(dcotuned, dother)
title(['kstest2: p = ' num2str(p)])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/Granger-decoupling-MC-DC_qqplot_bootstrap_rotated.eps')
