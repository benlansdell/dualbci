...
blackrock = './blackrock/';
labview = './labview/';
scriptname = './2015_07_24-CursorDecoding/glm_decoding_all.m';
scriptdesc = ['GLM decoding of cursor position based on GLM w spike history filter '...
...
for idx = 1:nR
	...
	if exist([blackrock nevfile], 'file')
		processGLMDecoding(conn, modelID, blackrock, labview, nevfile, BCnevfile, nevfile2, expt_id, paramcode, verbose);
	else
