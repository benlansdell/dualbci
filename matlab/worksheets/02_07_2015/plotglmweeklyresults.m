function plotglmweeklyresults(modeltype)
	if (nargin < 1) modeltype = 'sprc_pos_lv'; end
	threshdev = 1e20;
	...
	for i = 1:length(conds)
	    ...
	    clf;
	    fn_out = ['./worksheets/02_07_2015/plots/' modeltype '_' condition '.eps'];
	    colormap(hot);
	    imagesc(devs{i}');
	    ...
	    fn_out = ['./worksheets/02_07_2015/plots/' modeltype '_' condition '_toptendev.eps'];
	    saveplot(gcf, fn_out)
	    ...
	    xlabel('Week')
	    ylabel('Deviance')
	    fn_out = ['./worksheets/02_07_2015/plots/' modeltype '_' condition '_boxplot.eps'];
	    saveplot(gcf, fn_out)    
