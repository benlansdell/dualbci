...
for i = 1:nAlpha
	...
	subplot(3,1,3)
	xlabel('time (s)')
	fn_out3 = ['./worksheets/11_2_2014/plots/filterstrengths_alpha_' num2str(alphas(i)) '.eps'];
	...
	xlabel('time(s)')
	fn_out3 = ['./worksheets/11_2_2014/plots/filterstrengths_alpha_' num2str(alphas(i)) '_fourier.eps'];
	saveplot(gcf, fn_out3, 'eps', [9 6]);
end
