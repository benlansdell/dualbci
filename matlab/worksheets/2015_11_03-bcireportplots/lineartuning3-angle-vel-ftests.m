...
mc1bc_difftheta = center_angles(all_r2(:,1), all_r2(:,2));
mc1mc2_difftheta = center_angles(all_r2(:,1), all_r2(:,3));
mc2bc_difftheta = center_angles(all_r2(:,3), all_r2(:,2));
mcdc_difftheta = center_angles(all_r2(:,1), all_r2(:,4));
bcdc_difftheta = center_angles(all_r2(:,2), all_r2(:,4));

bci_mc1bc_difftheta = center_angles(all_r2(bci,1), all_r2(bci,2));
bci_mc1mc2_difftheta = center_angles(all_r2(bci,1), all_r2(bci,3));
bci_mc2bc_difftheta = center_angles(all_r2(bci,3), all_r2(bci,2));
bci_mcdc_difftheta = center_angles(all_r2(bci,1), all_r2(bci,4));
bci_bcdc_difftheta = center_angles(all_r2(bci,2), all_r2(bci,4));

nonbci_mc1bc_difftheta = center_angles(all_r2(nonbci,1), all_r2(nonbci,2));
nonbci_mc1mc2_difftheta = center_angles(all_r2(nonbci,1), all_r2(nonbci,3));
nonbci_mc2bc_difftheta = center_angles(all_r2(nonbci,3), all_r2(nonbci,2));
nonbci_mcdc_difftheta = center_angles(all_r2(nonbci,1), all_r2(nonbci,4));
nonbci_bcdc_difftheta = center_angles(all_r2(nonbci,2), all_r2(nonbci,4));
...
[h_mc1bc, p_mc1bc] = vartest2(bci_mc1bc_difftheta, nonbci_mc1bc_difftheta, 0.01)
[h_mc1mc2, p_mc1mc2] = vartest2(bci_mc1mc2_difftheta, nonbci_mc1mc2_difftheta, 0.01)
[h_mc2bc, p_mc2bc] = vartest2(bci_mc2bc_difftheta, nonbci_mc2bc_difftheta, 0.01)
[h_mcdc, p_mcdc] = vartest2(bci_mcdc_difftheta, nonbci_mcdc_difftheta, 0.01)
[h_bcdc, p_bcdc] = vartest2(bci_bcdc_difftheta, nonbci_bcdc_difftheta, 0.01)

[h_mc1bc_bci, p_mc1bc_bci] = vartest2(bci_mc1mc2_difftheta, bci_mc1bc_difftheta, 0.01)
[h_mc2bc_bci, p_mc2bc_bci] = vartest2(bci_mc1mc2_difftheta, bci_mc2bc_difftheta, 0.01)
[h_mcdc_bci, p_mcdc_bci] = vartest2(bci_mc1mc2_difftheta, bci_mcdc_difftheta, 0.01)
[h_bcdc_bci, p_bcdc_bci] = vartest2(bci_mc1mc2_difftheta, bci_bcdc_difftheta, 0.01)

[h_mc1bc_nonbci, p_mc1bc_nonbci] = vartest2(nonbci_mc1mc2_difftheta, nonbci_mc1bc_difftheta, 0.01);
[h_mc2bc_nonbci, p_mc2bc_nonbci] = vartest2(nonbci_mc1mc2_difftheta, nonbci_mc2bc_difftheta, 0.01);
[h_mcdc_nonbci, p_mcdc_nonbci] = vartest2(nonbci_mc1mc2_difftheta, nonbci_mcdc_difftheta, 0.01);
[h_bcdc_nonbci, p_bcdc_nonbci] = vartest2(nonbci_mc1mc2_difftheta, nonbci_bcdc_difftheta, 0.01);
...
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/tuningangle-bciVnonbci.eps', 'eps', [10 6])
