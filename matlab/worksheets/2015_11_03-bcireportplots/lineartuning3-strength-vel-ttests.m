...
figure 
bar([mean(mc1mc2_diffsize), mean(mc1bc_diffsize), mean(mcdc_diffsize)])
hold on 
errorbar([mean(mc1mc2_diffsize), mean(mc1bc_diffsize), mean(mcdc_diffsize)], ...
	[std(mc1mc2_diffsize), std(mc1bc_diffsize), std(mcdc_diffsize)])
ylabel('\Delta size')
%ylim([0 120])
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/tuningstrength-conditions-bargraph.eps')
