...
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/GCvtuning_MC_BC_data_thresh_tuningsize_0_2.eps')
...
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/GCvtuning_MC_hemispheres_data_thresh_tuningsize_0_2.eps')
...
ylim([0 30])
legend([h1, h3], 'contra-contra', 'contra-ipsi')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/GCvtuning_BC_hemispheres_data_thresh_tuningsize_0_2.eps')
...
xlabel('$\theta_j-\theta_i$')
legend([h1, h3], 'manual control', 'brain control')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/tuningvpropsig_MC_BC_data_thresh_tuningsize_0_2.eps')
...
xlabel('$\theta_j-\theta_i$')
legend([h1, h3], 'contra->contra', 'contra->ipsi')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/tuningvpropsig_MC_hemispheres_data_thresh_tuningsize_0_2.eps')
...
xlabel('$\theta_j-\theta_i$')
legend([h1, h3], 'contra->contra', 'contra->ipsi')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/tuningvpropsig_BC_hemispheres_data_thresh_tuningsize_0_2.eps')
...
ylim([0 .4])
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/gcscorevproptuned_MC_BC_thresh_tuningsize_0_2.eps')
...
ylim([0 .4])
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/gcscorevproptuned_MC_hemispheres_thresh_tuningsize_0_2.eps')
...
legend('contra->contra', 'contra->ipsi', 'ipsi->contra', 'location', 'northeast')
ylim([0 .4])
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/gcscorevproptuned_BC_hemispheres_thresh_tuningsize_0_2.eps')
...
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/gcscorevtuningoverlap_MC_thresh_tuningsize_0_2.eps')
...
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/gcscorevtuningoverlap_BC_thresh_tuningsize_0_2.eps')
...
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/hist_tuning_all_thresh_tuningsize_0_2.eps')
hist(MC_d(:,2)/pi*180, 50) 
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/hist_tuning_MC_thresh_tuningsize_0_2.eps')
hist(BC_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/hist_tuning_BC_thresh_tuningsize_0_2.eps')
hist(MC_CC_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/hist_tuning_MC_CC_thresh_tuningsize_0_2.eps')
hist(MC_CI_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/hist_tuning_MC_CI_thresh_tuningsize_0_2.eps')
hist(MC_IC_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/hist_tuning_MC_IC_thresh_tuningsize_0_2.eps')
hist(MC_II_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/hist_tuning_MC_II_thresh_tuningsize_0_2.eps')
hist(BC_IC_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/hist_tuning_BC_IC_thresh_tuningsize_0_2.eps')
hist(BC_II_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/hist_tuning_BC_II_thresh_tuningsize_0_2.eps')
hist(BC_CI_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/hist_tuning_BC_CI_thresh_tuningsize_0_2.eps')
hist(BC_CC_d(:,2)/pi*180, 50)
xlabel('angle')
ylabel('frequency')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/hist_tuning_BC_CC_thresh_tuningsize_0_2.eps')
...
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/prop_fe_ru_MC_thresh_tuningsize_0_2.eps')
...
xlim([0 gcthresholds(ii(end))]);
legend('other', 'both tuned RU', 'both tuned FE', 'location', 'northwest')
saveplot(gcf, './worksheets/2015_11_03-bcireportplots/prop_fe_ru_BC_thresh_tuningsize_0_2.eps')
