...
for idx = 1:nR
	...
	if exist([blackrock nevfile], 'file') & exist([blackrock BCnevfile], 'file') & exist([blackrock DCnevfile], 'file') & exist([blackrock MC2nevfile], 'file')
		...
		%processLinearControl(conn, modelID, blackrock, BCnevfile, paramcode, threshold, reftorqdist, allunits, rerun);
		%processLinearControl(conn, modelID, blackrock, DCnevfile, paramcode, threshold, reftorqdist, allunits, rerun);
		processLinearControl(conn, modelID, blackrock, MC2nevfile, paramcode, threshold, reftorqdist, allunits, rerun);
	else
