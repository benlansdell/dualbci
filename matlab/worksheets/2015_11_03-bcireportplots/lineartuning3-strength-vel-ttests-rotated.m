...
mc1mc2_diffsize = all_r2(rot,1)- all_r2(rot,3);
mc2bc_diffsize = all_r2(rot,3)- all_r2(rot,2);
mcdc_diffsize = all_r2(rot,1)- all_r2(rot,4);
bcdc_diffsize = all_r2(rot,2)- all_r2(rot,4);
...
ylabel('\Delta size')
%ylim([0 120])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/tuningstrength-conditions-bargraph-rotated.eps')
...
colormap(colors)
subplot(2,2,1)
scatter(all_r2(rot,1), all_r2(rot,2), [], cc(rot))
hold on 
plot([0 3], [0 3], 'k')
xlim([0 3])
ylim([0 3])
...
subplot(2,2,2)
scatter(all_r2(rot,1), all_r2(rot,3), [], cc(rot))
hold on 
plot([0 3], [0 3], 'k')
xlim([0 3])
ylim([0 3])
...
subplot(2,2,3)
scatter(all_r2(rot,2), all_r2(rot,4), [], cc(rot))
hold on 
plot([0 3], [0 3], 'k')
xlim([0 3])
ylim([0 3])
...
ylabel('strength DC')
subplot(2,2,4)
scatter(all_r2(rot,1), all_r2(rot,4), [], cc(rot))
hold on 
plot([0 3], [0 3], 'k')
xlim([0 3])
ylim([0 3])
...
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/tuningstrength-conditions-scatter-rotated.eps')
