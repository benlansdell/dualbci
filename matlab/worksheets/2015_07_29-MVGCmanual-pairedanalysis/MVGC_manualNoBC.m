...
blackrock = './blackrock/';
labviewpath = './labview/';
scriptname = './2015_07_29-MVGC_manual/MVGC_manualNoBC.m';
...
for idx = 1:nR
	...
	if exist([blackrock nevfile1], 'file') & exist([blackrock BCnevfile], 'file') & exist([blackrock nevfile2], 'file')
		processMVGCmanualPairedNoBCI(conn, modelID, blackrock, labviewpath, nevfile1, BCnevfile, nevfile2, expt_id, paramcode);
		c = c+1;
	else
