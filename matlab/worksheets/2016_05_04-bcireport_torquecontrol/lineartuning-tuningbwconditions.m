...
'ON flin5.id = fl5.id '...
'WHERE flin1.modelID = 36 AND flin2.modelID = 36 AND flin3.modelID = 36 AND flin5.modelID = 36 ' ...
...
saveplot(gcf, './worksheets/2016_05_04-bcireport_torquecontrol/tuningstrength_position.eps', 'eps', [10 6])
...
'INNER JOIN `fits_linear` fl5 '...
'ON flin5.id = fl5.id '...
'WHERE flin1.modelID = 39 AND flin2.modelID = 39 AND flin3.modelID = 39 AND flin5.modelID = 39 ' ...
'AND flin1.unit = flin2.unit AND flin2.unit = flin3.unit AND flin2.unit = flin5.unit ']));
all_r2 = cell2mat(all_data.Data(:,1:4));
all_r2out = cell2mat(all_data.Data(:,5:8));
tuningtype = cell2mat(all_data.Data(:,9));
...
saveplot(gcf, './worksheets/2016_05_04-bcireport_torquecontrol/tuningstrength_velocity.eps', 'eps', [10 6])
...
saveplot(gcf, './worksheets/2016_05_04-bcireport_torquecontrol/tuningstrength_velocity_rotated.eps', 'eps', [10 6])
...
ylabel('\theta DC')
title(['corr rotated: ' num2str(corrsrotated(5)) ' corr unrotated: ' num2str(corrsunrotated(5))])
saveplot(gcf, './worksheets/2016_05_04-bcireport_torquecontrol/tuningangles_velocity.eps', 'eps', [10 6])
...
ylabel('\theta DC')
title(['corr rotated: ' num2str(corrsrotated(5)) ' corr unrotated: ' num2str(corrsunrotated(5))])
saveplot(gcf, './worksheets/2016_05_04-bcireport_torquecontrol/tuningangles_position.eps', 'eps', [10 6])
