...
for idx = 1:nEl
	...
	if sum(nz) > 0
		...
		saveplot(gcf, ['./worksheets/03_25_2015/plots/2dmanualpos_1day_sprc-sprcposvel_unit_' num2str(idx) '_n_' num2str(n) '.eps'], 'eps', [5 20])
	end
end
...
ylabel('Day 0')
title(['Time driving BCI'])		
saveplot(gcf, ['./worksheets/03_25_2015/plots/2dmanualpos_1day_sprc-sprcposvel_all_N_' num2str(N) '.eps'], 'eps', [5 20])
...
for idx = 1:nEl
	...
	if sum(nz) > 0
		...
		ylabel('DP')
		title(['Time driving BCI'])		
		saveplot(gcf, ['./worksheets/03_25_2015/plots/2dmanualpos_1day_sprc-sprcposvel_date_unit_' num2str(idx) '_n_' num2str(n) '.eps'], 'eps', [5 20])
	end
end
...
ylabel('DP')
title(['Time driving BCI'])		
saveplot(gcf, ['./worksheets/03_25_2015/plots/2dmanualpos_1day_sprc-sprcposvel_all_date_N_' num2str(N) '.eps'], 'eps', [5 20])
