...
mat_sprc_relpos = load('./expts/2dmanualpos_sprc_pos_def.mat');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Note their change in deviance between sprc and sprc_pos%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for idx = 1:nEl
	...
	if sum(nz) > 0
		...
		saveplot(gcf, ['./worksheets/03_30_2015/plots/2dmanualpos_1day_sprc-sprcpos_unit_' num2str(idx) '_n_' num2str(n) '.eps'], 'eps', [5 20])
	end
end
...
ylabel('Day 0')
title(['Time driving BCI'])		
saveplot(gcf, ['./worksheets/03_30_2015/plots/2dmanualpos_1day_sprc-sprcpos_all_N_' num2str(N) '.eps'], 'eps', [5 20])
...
for idx = 1:nEl
	...
	if sum(nz) > 0
		...
		ylabel('DP')
		title(['Time driving BCI'])		
		saveplot(gcf, ['./worksheets/03_30_2015/plots/2dmanualpos_1day_sprc-sprcpos_date_unit_' num2str(idx) '_n_' num2str(n) '.eps'], 'eps', [5 20])
	end
end
...
ylabel('DP')
title(['Time driving BCI'])		
saveplot(gcf, ['./worksheets/03_30_2015/plots/2dmanualpos_1day_sprc-sprcpos_all_date_N_' num2str(N) '.eps'], 'eps', [5 20])
