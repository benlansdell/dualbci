...
fn_out = './worksheets/10_18_2014/data_cosine.mat';
N = 200000;
binsize = 0.002;
dur = N*binsize;
dt_sp = binsize;
...
for i = 1:nAlpha
	...
	for j = 1:length(nK_poss);
		...
		%now filters fits are in fourier space. Take ifft of filters before plotting them
		data = filters_sp_pos_cosine(processed{i}, nK_sp, nK_pos, dt_sp, dt_pos);
		...
		fn_out2 = ['./worksheets/10_18_2014/plots/filterstrengths_cosine_alpha_' num2str(alphas(i)) '_dtpos_' num2str(dt_pos)];
	...
	xlabel('time (s)')
	fn_out3 = ['./worksheets/10_18_2014/plots/filterstrengths_cosine_alpha_' num2str(alphas(i)) '.eps'];
...
colorbar
saveplot(gcf, './worksheets/10_18_2014/plots/filterstrengths_cosine_dev.eps')
