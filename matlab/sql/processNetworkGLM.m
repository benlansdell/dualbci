function processNetworkGLM(conn, modelID, blackrock, nevfile, paramcode, units)
	...
	data = filters_sprc_pos_network(processed, nK_sp, nK_pos, dt_sp, dt_pos)
	model = MLE_glmfit_network(data, const);
	%%Compute MSE on test data
	datanovel = filters_sprc_pos_network(processed_novel, nK_sp, nK_pos, dt_sp, dt_pos);
