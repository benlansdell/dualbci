function processLinearSuccessPosition(conn, modelID, blackrock, nevfile, paramcode, threshold, units, rerun)
		%processLinearSuccessPosition(conn, modelID, blackrock, nevfile, paramcode, threshold, allunits, rerun);
	...
	if size(processed.binnedspikes,1)*processed.binsize < dur+testdur
