function processGLM(conn, modelID, blackrock, labviewpath, nevfile, matfile, paramcode, units)
	...
	data = filters_sprc_pos_target(processed, nK_sp, nK_pos, nK_tar, dt_sp, dt_pos, dt_tar);
	model = MLE_glmfit(data, const);
	%%Compute MSE on test data
	datanovel = filters_sprc_pos_target(processed_novel, nK_sp, nK_pos, nK_tar, dt_sp, dt_pos, dt_tar);
