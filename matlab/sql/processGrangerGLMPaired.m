function processGrangerGLMPaired(conn, modelID, blackrock, labviewpath, MCnevfile1, BCnevfile1, MCnevfile2, DCnevfile, expt_id, paramcode)
	...
	runGrangerPaired(conn, analysis_id, modelID, blackrock, labviewpath, MCnevfile1, allunits, expt_id, paramcode);
	runGrangerPaired(conn, analysis_id, modelID, blackrock, labviewpath, MCnevfile2, allunits, expt_id, paramcode);
	runGrangerPaired(conn, analysis_id, modelID, blackrock, labviewpath, BCnevfile1, allunits, expt_id, paramcode);
	runGrangerPaired(conn, analysis_id, modelID, blackrock, labviewpath, DCnevfile, allunits, expt_id, paramcode);
end 

function runGrangerPaired(conn, analysis_id, modelID, blackrock, labviewpath, nevfile, units, expt_id, paramcode)
