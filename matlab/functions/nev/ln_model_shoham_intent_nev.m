function [r2 LNr2 loglikelihoods, lp] = ln_model_shoham_intent_nev(nevfile, matfile, fn_out, kernellength, polydeg)
	%ln_model_shoham_intent_nev	Function to fit the following model to spike and torque data:
