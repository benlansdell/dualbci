function corr2 = corr_mua2(nevfiles, binsize, fn_out, sigma, offset)
	%corr_mua2	Function to compute correlation between spike trains (firing rates) for a set of 
	...
	%		
	%		Output:
	%			corr2 = [nE x 2] array listing correlation between each of nE electrodes and torque motion
	%				in each axis
	%
	%		Test code:
