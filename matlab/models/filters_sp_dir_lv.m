function data = filters_sp_dir_lv(processed, nK_sp, nK_dir, dt_sp, dt_dir)
	...
	%
	%Usage:
	%	data = filters_sp_dir_lv(processed, nK_sp, nK_dir, dt_sp, dt_dir)
	%     
	%Input:
	...
	%	dt_sp = 0.002;
	%	dt_dir = 0.05;
	%	data = filters_sp_dir_lv(pre.processed, nK_sp, nK_dir, dt_sp, dt_dir);
