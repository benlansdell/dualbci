function data = filters_sp_vel_lv(processed, nK_sp, nK_vel, dt_sp, dt_vel)
	...
	data.cursor = processed.cursor((nK_sp*steps_sp+1):(nB-nK_vel*steps_pos),:); 
	data.dcursor = processed.dcursor((nK_sp*steps_sp+1):(nB-nK_vel*steps_pos),:);
	data.ddcursor = processed.ddcursor((nK_sp*steps_sp+1):(nB-nK_vel*steps_pos),:);
