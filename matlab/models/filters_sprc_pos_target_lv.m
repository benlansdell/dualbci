function data = filters_sprc_pos_target_lv(processed, nK_sp, nK_pos, nK_tar, dt_sp, dt_pos, dt_tar)
	...
	%
	%Usage:
	%	data = filters_sprc_pos_target_lv(processed, nK_sp, nK_pos, dt_sp, dt_pos)
	%     
	%Input:
