function data = filters_sp_pos_target(processed, nK_sp, nK_pos, nK_tar, dt_sp, dt_pos, dt_tar)
	...
	%	dt_sp = 0.002;
	%	dt_pos = 0.05;
	%	data = filters_sp_pos_target(pre.processed, nK_sp, nK_pos, dt_sp, dt_pos);
