function [iht, ihbas, ihbasis] = makeBasis_PostSpike(ihprs,dt,timeafterspk,ppms)
...
%mxt = invnl(yrnge(2)+2*db)-b;  % maximum time bin   %REBECCA AND ADRIENNE
%12/11

mxt = timeafterspk*dt*ppms;    % SANGWOOK 8/13
iht = (0:dt:mxt)';
