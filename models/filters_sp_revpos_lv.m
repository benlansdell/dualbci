function data = filters_sp_revpos_lv(processed, nK_sp, nK_pos, dt_sp, dt_pos)
	...
	%
	%Usage:
	%	data = filters_sp_revpos_lv(processed, nK_sp, nK_pos, dt_sp, dt_pos)
	%     
	%Input:
	...
	%	dt_sp = 0.002;
	%	dt_pos = 0.05;
	%	data = filters_sp_revpos_lv(pre.processed, nK_sp, nK_pos, dt_sp, dt_pos);
