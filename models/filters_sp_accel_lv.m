function data = filters_sp_accel_lv(processed, nK_sp, nK_acc, dt_sp, dt_acc)
	...
	%
	%Usage:
	%	data = filters_sp_accel_lv(processed, nK_sp, nK_acc, dt_sp, dt_acc)
	%     
	%Input:
	...
	%	dt_sp = 0.002;
	%	dt_acc = 0.05;
	%	data = filters_sp_accel_lv(pre.processed, nK_sp, nK_acc, dt_sp, dt_acc);
