function data = filters_sp_revvel_lv(processed, nK_sp, nK_vel, dt_sp, dt_vel)
	...
	%
	%Usage:
	%	data = filters_sp_revvel_lv(processed, nK_sp, nK_vel, dt_sp, dt_vel)
	%     
	%Input:
	...
	%	dt_sp = 0.002;
	%	dt_vel = 0.05;
	%	data = filters_sp_revvel_lv(pre.processed, nK_sp, nK_vel, dt_sp, dt_vel);
