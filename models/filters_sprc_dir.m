function data = filters_sprc_dir(processed, nK_sp, nK_dir, dt_sp, dt_dir)
	...
	%
	%Usage:
	%	data = filters_sprc_dir(processed, nK_sp, nK_dir, dt_sp, dt_dir)
	%     
	%Input:
	...
	%	dt_sp = 0.002;
	%	dt_dir = 0.05;
	%	data = filters_sprc_dir(pre.processed, nK_sp, nK_dir, dt_sp, dt_dir);
