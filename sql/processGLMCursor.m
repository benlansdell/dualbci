function processGLMCursor(conn, modelID, blackrock, labviewpath, nevfile, matfile, paramcode, units)
	...
	%Preprocess data
	if nargin < 8
		processed = preprocess_spline_lv(nevpath, binsize, threshold, offset);
		units = 0;
	else
	...
	datanovel = filters_sprc_pos_lv(processed_novel, nK_sp, nK_pos, dt_sp, dt_pos);
