function processForRevGLM(conn, modelID, blackrock, labviewpath, nevfile, paramcode, units)
	...
	datanovel = filters_sprc_forrevpos(processed_novel, nK_sp, nK_pos, dt_sp, dt_pos);
