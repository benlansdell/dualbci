...
%Model 32 fits TE over a longer set of training data
modelID = 32;
blackrock = './blackrock/';
labviewpath = './labview/';
...
for idx = 105:108
	...
	if ~strcmp(MCnevfile1, 'null') & ~strcmp(MCnevfile2, 'null') & ~strcmp(BCnevfile1, 'null') & ~strcmp(DCnevfile, 'null')
		...
		processTEtoolbox(conn, modelID, blackrock, labviewpath, MCnevfile1, BCnevfile1, MCnevfile2, DCnevfile, expt_id, paramcode);
	else
