...
figure
subplot(2,2,1)
violinplot(180/pi*bci_mc1bc_difftheta, 'c1', 'ShowData', false);
ylim([0, 180])
title('BCI. MC-BC')
subplot(2,2,2)
violinplot(180/pi*nonbci_mc1bc_difftheta, 'c1', 'ShowData', false);
ylim([0, 180])
title('Non BCI. MC-BC')
subplot(2,2,3)
violinplot(180/pi*bci_mcdc_difftheta, 'c1', 'ShowData', false);
ylim([0, 180])
title('BCI. MC-DC')
subplot(2,2,4)
violinplot(180/pi*nonbci_mcdc_difftheta, 'c1', 'ShowData', false);
title('Non BCI. MC-DC')
ylim([0, 180])
saveplot(gcf, './figures/tuningangleBCI-nonBCI-violin-rotated.eps')
