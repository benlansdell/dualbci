...
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/GC-decoupling-MC-BC_histogram_bootstrap.eps')
...
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/GC-decoupling-MC-BC_qqplot_bootstrap.eps')
...
xlim([-50 50])
%legend('Cotuned with BC-unit', 'Randomly selected unit')
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/GC-decoupling-MC-DC_histogram_bootstrap.eps')
...
[h, p] = kstest2(dcotuned, dother)
title(['kstest2: p = ' num2str(p)])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/GC-decoupling-MC-DC_qqplot_bootstrap.eps')
