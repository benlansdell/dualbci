...
figure 
subplot(1,3,1)
violinplot(180/pi*mc1mc2_difftheta, 'c1', 'ShowData', false);
ylabel('|\Delta \theta|');
ylim([0 180]);
subplot(1,3,2)
violinplot(180/pi*mc1bc_difftheta, 'c1', 'ShowData', false);
ylim([0 180]);
subplot(1,3,3)
violinplot(180/pi*mcdc_difftheta, 'c1', 'ShowData', false);
ylim([0 180]);

saveplot(gcf, './figures/tuningangle-conditions-violin-rotated.eps')
