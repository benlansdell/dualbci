...
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TE-decoupling-MC-BC_histogram_bootstrap_cotunedcontrol.eps')
...
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TE-decoupling-MC-BC_qqplot_bootstrap_cotunedcontrol.eps')
...
title(['abs(dcotuned)vs abs(dothercotuned) p-value: ' num2str(p)])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TE-decoupling-MC-DC_histogram_bootstrap_cotunedcontrol.eps')
...
[h, p] = kstest2(dcotuned, dothercotuned)
title(['kstest2: p = ' num2str(p)])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TE-decoupling-MC-DC_qqplot_bootstrap_cotunedcontrol.eps')
