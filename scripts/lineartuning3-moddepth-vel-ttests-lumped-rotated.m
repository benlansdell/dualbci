...
mc1bc_diffsize = moddepth(rot,1) - moddepth(rot,2);
mcdc_diffsize = moddepth(rot,1)- moddepth(rot,3);
bcdc_diffsize = moddepth(rot,2)- moddepth(rot,3);
...
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/tuningmoddepthBCI-nonBCI-boxplot-rotated.eps')
...
colormap(colors)
subplot(2,2,1)
scatter(moddepth(rot,1), moddepth(rot,2), [], cc(rot))
xlabel('strength MC1')
ylabel('strength BC1')
%title(['corr bci: ' num2str(corrsbci(1)) ' corr nonbci: ' num2str(corrsnonbci(1))])
subplot(2,2,2)
scatter(moddepth(rot,1), moddepth(rot,3), [], cc(rot))
xlabel('strength MC1')
ylabel('strength DC')
%title(['corr bci: ' num2str(corrsbci(2)) ' corr nonbci: ' num2str(corrsnonbci(2))])
subplot(2,2,3)
scatter(moddepth(rot,2), moddepth(rot,3), [], cc(rot))
xlabel('strength BC1')
ylabel('strength DC')
%title(['corr bci: ' num2str(corrsbci(3)) ' corr nonbci: ' num2str(corrsnonbci(3))])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/tuningmoddepthBCI-nonBCI-scatter-rotated.eps')