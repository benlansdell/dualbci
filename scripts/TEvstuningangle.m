...
'ON flin2.id = fl2.id '...
'WHERE flin1.modelID = 30 AND flin2.modelID = 30 AND fgranger.modelID = 37']));
...
ylabel('TE score between units')
title('Brain+manual. Ipsi+contra')
xlim([-180 180])
ylim([-0.001 0.002])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TEvtuning_alldata.eps')
...
xlabel('Difference in tuning angles between units')
title('Brain+manual. Ipsi+contra')
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TEtuningvpropsig_alldata.eps')
...
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TEvtuning_MCdata.eps')
...
xlabel('Difference in tuning angles between units')
title('manual. Ipsi+contra')
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TEtuningvpropsig_MCdata.eps')
...
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TEvtuning_BCdata.eps')
...
xlabel('Difference in tuning angles between units')
title('Brain. Ipsi+contra')
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TEtuningvpropsig_BCdata.eps')
...
'ON flin2.id = fl2.id '...
' INNER JOIN experiment_tuning et '...
' ON et.`dualrecording` = flin1.`nev file` '...
'WHERE flin1.modelID = 30 AND flin2.modelID = 30 AND fgranger.modelID = 37']));
...
xlabel('Difference in tuning angles between units')
ylabel('TE score between units')
title('Dual. Ipsi+contra')
xlim([-180 180])
ylim([-0.001 0.002])

saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TEvtuning_DCdata.eps')
...
xlabel('Difference in tuning angles between units')
title('Dual. Ipsi+contra')
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TEtuningvpropsig_DCdata.eps')
