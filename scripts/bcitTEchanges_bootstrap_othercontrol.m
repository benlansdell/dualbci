...
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TE-decoupling-MC-BC_histogram_bootstrap_othercontrol.eps')
...
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TE-decoupling-MC-BC_qqplot_bootstrap_othercontrol.eps')
...
title(['abs(dbci)vs abs(dother) p-value: ' num2str(p)])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TE-decoupling-MC-DC_histogram_bootstrap_othercontrol.eps')
...
[h, p] = kstest2(dcotuned, dothercotuned)
title(['kstest2: p = ' num2str(p)])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/TE-decoupling-MC-DC_qqplot_bootstrap_othercontrol.eps')
