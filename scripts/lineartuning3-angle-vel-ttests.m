...
mc1bc_difftheta = abs(center_angles(all_r2(:,1), all_r2(:,2)));
mc1mc2_difftheta = abs(center_angles(all_r2(:,1), all_r2(:,3)));
mc2bc_difftheta = abs(center_angles(all_r2(:,3), all_r2(:,2)));
mcdc_difftheta = abs(center_angles(all_r2(:,1), all_r2(:,4)));
bcdc_difftheta = abs(center_angles(all_r2(:,2), all_r2(:,4)));
...
ylabel('|\Delta \theta|')
ylim([0 120])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/tuningangle-conditions-bargraph.eps')
...
colormap(colors)
subplot(2,3,1)
scatter(180/pi*all_r2(:,1), 180/pi*translate_angles(all_r2(:,1), all_r2(:,2)), [], cc(:), '.')
xlabel('\theta MC1')
ylabel('\theta BC1')
title(['corr bci: ' num2str(corrsbci(1)) ' corr nonbci: ' num2str(corrsnonbci(1))])
subplot(2,3,2)
scatter(180/pi*all_r2(:,1), 180/pi*translate_angles(all_r2(:,1), all_r2(:,3)), [], cc(:), '.')
xlabel('\theta MC1')
ylabel('\theta MC2')
title(['corr bci: ' num2str(corrsbci(2)) ' corr nonbci: ' num2str(corrsnonbci(2))])
subplot(2,3,3)
scatter(180/pi*all_r2(:,3), 180/pi*translate_angles(all_r2(:,3), all_r2(:,2)), [], cc(:), '.')
ylabel('\theta BC1')
xlabel('\theta MC2')
title(['corr bci: ' num2str(corrsbci(3)) ' corr nonbci: ' num2str(corrsnonbci(3))])
subplot(2,3,5)
scatter(180/pi*all_r2(:,1), 180/pi*translate_angles(all_r2(:,1), all_r2(:,4)), [], cc(:), '.')
xlabel('\theta MC1')
ylabel('\theta DC')
title(['corr bci: ' num2str(corrsbci(4)) ' corr nonbci: ' num2str(corrsnonbci(4))])
subplot(2,3,6)
scatter(180/pi*all_r2(:,2), 180/pi*translate_angles(all_r2(:,2), all_r2(:,4)), [], cc(:), '.')
xlabel('\theta BC1')
ylabel('\theta DC')
title(['corr bci: ' num2str(corrsbci(5)) ' corr nonbci: ' num2str(corrsnonbci(5))])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/tuningangle-bciVnonbci.eps', 'eps', [10 6])
