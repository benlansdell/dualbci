...
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/Granger-decoupling-MC-BC_histogram_bootstrap.eps')

figure 
qqplot(dcotuned, dother)
[h, p] = kstest2(dcotuned, dother)
title(['kstest2: p = ' num2str(p)])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/Granger-decoupling-MC-BC_qqplot_bootstrap.eps')
...
[h, p] = ttest2(abs(dcotuned), abs(dother))
title(['abs(dcotuned)vs abs(dother) p-value: ' num2str(p)])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/Granger-decoupling-MC-DC_histogram_bootstrap.eps')
...
[h, p] = kstest2(dcotuned, dother)
title(['kstest2: p = ' num2str(p)])
saveplot(gcf, './worksheets/2016_06_10-resultsforpaper/Granger-decoupling-MC-DC_qqplot_bootstrap.eps')
