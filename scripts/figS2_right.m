...
%
%save('./scripts/figS2_right.mat')
load('./scripts/figS2_right.mat')
...
mcdc_difftheta = abs(center_angles(all_r2(unrot,1), all_r2(unrot,3)));
bcdc_difftheta = abs(center_angles(all_r2(unrot,2), all_r2(unrot,3)));
